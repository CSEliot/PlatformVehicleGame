...
#include "jumpercablesWheelFront.h"
#include "jumpercablesWheelRear.h"
...
const FName AjumpercablesPawn::LookUpBinding("LookUp");
const FName AjumpercablesPawn::LookRightBinding("LookRight");
const FName AjumpercablesPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AjumpercablesPawn::AjumpercablesPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UjumpercablesWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UjumpercablesWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UjumpercablesWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UjumpercablesWheelRear::StaticClass();
...
void AjumpercablesPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// set up gameplay key bindings
	check(InputComponent);

	InputComponent->BindAxis("MoveForward", this, &AjumpercablesPawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AjumpercablesPawn::MoveRight);
	InputComponent->BindAxis(LookUpBinding);
	InputComponent->BindAxis(LookRightBinding);

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &AjumpercablesPawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &AjumpercablesPawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AjumpercablesPawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AjumpercablesPawn::OnResetVR); 
}

void AjumpercablesPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AjumpercablesPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AjumpercablesPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AjumpercablesPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AjumpercablesPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AjumpercablesPawn::EnableIncarView(const bool bState)
{
...
void AjumpercablesPawn::Tick(float Delta)
{
...
void AjumpercablesPawn::BeginPlay()
{
...
void AjumpercablesPawn::OnResetVR()
{
#ifdef HMD_INTGERATION
...
void AjumpercablesPawn::UpdateHUDStrings()
{
...
void AjumpercablesPawn::SetupInCarHUD()
{
...
void AjumpercablesPawn::UpdatePhysicsMaterial()
{
